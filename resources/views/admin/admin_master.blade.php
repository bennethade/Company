...
<html lang="en" dir="ltr">
  ...
  <link href="{{ asset('assets/plugins/flag-icons/css/flag-icon.min.cs') }}" rel="stylesheet"/>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      ...
                      {{-- <img src="{{ $user->profile_photo_path }}" class="user-image" alt="" /> --}}
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li class="dropdown-header">
                        ...
                        {{-- <img src="{{ $user->profile_photo_path }}" class="img-circle" alt="" /> --}}
...
@yield('admin')
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2019</span> Copyright Anchor Hub ICT by
                <a
                  class="text-primary"
                  href="http://www.anchorhubict.com/"
                  target="_blank"
                  >Benard</a
                >.
              </p>
